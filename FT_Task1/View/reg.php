...
<tr>
<td> Designation: </td>
<td> <input type="radio" name="designation" value="Junior Programmar">Junior Programmar <br>
<input type="radio" name="designation" value="Senior Programmar">Senior Programmar <br>
...
<tr>
<td> Password : </td>
<td> <input type = "password" name= "password" placeholder="More than 4 characters"> </td>
<td> <?php echo $g ?> </td>
</tr>

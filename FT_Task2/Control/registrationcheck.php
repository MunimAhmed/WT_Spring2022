<?php
   ...
   $firstname= $lastname=$age=$email=$password=$confirmpassword=$errprogramming_language=$designation=$filename=$a=$b=$c=$d=$f=$g=$h="";
   ...
   {
    $errprogramming_language= "No Language Selected";
   }
